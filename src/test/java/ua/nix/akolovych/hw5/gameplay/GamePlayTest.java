package ua.nix.akolovych.hw5.gameplay;
...
import static ua.nix.akolovych.hw5.gameplay.TestUtils.textToArray;
...
class GamePlayTest {
    ...
    void game_FillsFieldWithSignsChecksWinner_Field3X3_ReturnGameIsContinue_LoadFile() throws IOException {
        // Arrange
        final int size = 3;
        Sign[][] testArray = textToArray("test_data_game_is_continue.txt", size);
    ...
    void game_FillsFieldWithSignsChecksWinner_Field3X3_ReturnCrossWinner_LoadFile() throws IOException {
        // Arrange
        final int size = 3;
        Sign[][] testArray = textToArray("test_data_side_diagonal_completed.txt", size);
    ...
    void game_FillsFieldWithSignsChecksWinner_Field3X3_ReturnCrossWinner_VerticalCompleted_LoadFile() throws IOException {
        // Arrange
        final int size = 3;
        Sign[][] testArray = textToArray("test_data_vertical_completed.txt", size);
    ...
    void game_FillsFieldWithSignsChecksWinner_Field3X3_ReturnCrossWinner_HorizontalCompleted_LoadFile() throws IOException {
        // Arrange
        final int size = 3;
        Sign[][] testArray = textToArray("test_data_horizontal_completed.txt", size);
    ...
    void game_FillsFieldWithSignsChecksWinner_Field3X3_ReturnGameIsContinue_EmptyField_LoadFile() throws IOException {
        // Arrange
        final int size = 3;
        Sign[][] testArray = textToArray("test_data_gameplay_with_empties.txt", size);
    ...
    void game_GetField_WithEmptyField_Field3X3_ReturnField_LoadFile() throws IOException {
        // Arrange
        final int size = 3;
        Sign[][] expected = textToArray("test_data_gameplay_with_empties.txt", size);
